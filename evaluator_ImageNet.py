...
if __name__ == '__main__':
    ...
    ##  model
    parser.add_argument('--arch', type=str, help="[deit_sat_small_patch16_224]", default='deit_sat_small_patch16_224')
    ##  GPU'                                  
    ...
    checkpoint = torch.load('logs/' + args.root + '_Pro2SAM' + '/' + args.arch + '/' + 'epoch_0.pth.tar')
    model.load_state_dict(checkpoint['model'])

    root_path = '/data/dss/ImageNet1K/val/'
    save_root = '/media/gpu/dss/code/WSOL/Pro2Mask/Data/ILSVRC/ImageNet_results_Pro2SAM_0.5/'
    ...
    for class_name in tqdm(sub_root_list, total=len(sub_root_list)):
        ...
        for image_name in class_root_list:
